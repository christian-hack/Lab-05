...
public class CalculatorTest {
    ...
    public void calculateTwoTokensTestInvalidCommand() throws AssertException
    {
        try
        {
        	...
        	Assert.fail("Illegal command did not enter halve or negate");
    ...
    public void calculateThreeTokensTestValidDivide() throws AssertException
    {
        try {
        	...
        	Assert.fail("Legal epression threw an exception: " + e.getMessage());
        }
    }
    ...
    {
        try {
        	Calculator.calculateThreeTokens(new String[] {"6", "*", "2"});
        	Assert.fail("Illegal Command did not enter +,-,/");
        } catch (CalculatorException e) {
        } catch (Exception e) {
        	Assert.fail("Unexpected Exception (not CalculatorException) caught");
        }
    ...
    public void executeTestValidQuit() throws AssertException
    {
        try {
        	...
        	Assert.fail("Did not terminate program properly");
        }
    }
    ...
    {
        try {
        	int result = Calculator.calculateThreeTokens(new String[] {"2", "-", "1"});
    ...
    public void executeTestInvalidTokenLength() throws AssertException
    {
        ...
        try {
        	...
        	Assert.fail("Illegal Token Length");
        } catch (CalculatorException e) {
    ...
    {
        try {
        	String result = Calculator.parseAndExecute("100000000000000 - 10");
        	Assert.assertEquals("Input number cannot be parsed to an int. Please try again.", result);
        } catch (Exception e) {
        	Assert.fail("Unexpected exception (Not NumberFormat) caught");
        }
    }
    ...
    {
        String result = Calculator.parseAndExecute("foo foo foo foo");
